...
#line 62
{
  ...
  if (TestC__RadioSend__send(AM_BROADCAST_ADDR, &TestC__testMsgBffr, sizeof(test_data_msg_t )) != SUCCESS) {
#line 66
    TestC__sendDone();
    }
#line 67
...
#line 28
{
  TestC__testMsg = (test_data_msg_t *)TestC__RadioSend__getPayload(&TestC__testMsgBffr, sizeof(test_data_msg_t ));
